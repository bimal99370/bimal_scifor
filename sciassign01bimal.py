# -*- coding: utf-8 -*-
"""SciAssign01BIMAL.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1VC8e0QH-CeW5ocsfKC74ylO8m0mEp5RZ
...
print("My name is Bimal choudhury")
print("my age is 23")
...
print(f"my name is {name}, i am {age}years old and i live in {add}")

#CHATBOT
print("hi, i AM A CHATBOY")
name = input("what is your name ")
print(f"oh,{name} in which grade you are right now ?")
grade = input("enter your grade")
print(f"{name} you are in {grade} class. can i ask you a question (yes/no)?")
answer = input("yes/no")
if answer == "yes":
  print("tell me 1024 + 98")
  value = int(input("enter the answer"))
  if value == 1122:
    print("fantastic answer, bye")
  else:
...
books=int(input("enter how many books you want to buy?"))
amount=(books) * 2
print(f"total price you have to pay is  {amount}$")
...
e=a*b
f=a/b
print(f" addition value is {c}")
print(f" substraction value is {d}")
print(f" multiplication value is {e}")
print(f" division value is {f}")

year_of_birth=int(input("enter the year you born?"))
